...
namespace Sistema.Datos
{
    public class DCategoria
    {
        ...
        {
            SqlDataReader Resultado;//proporciona una forma de leer una secuencia de filas de sql server
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("categoria_listar",SqlCon);//la calse sqlcomando transacc sql 
        ...
        public DataTable Buscar(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("categoria_buscar", SqlCon);//la calse sqlcomando transacc sql 
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Existe(string Valor)
        {
            ...
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@Valore", SqlDbType.VarChar).Value = Valor;
                SqlParameter ParExiste = new SqlParameter();
                ParExiste.ParameterName = "@exite";
        ...
        public string Insertar(Categoria Obj)
        {
            ...
            try
            {
                ...
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo ingresar la respuesata";
        ...
        public string Activar(int Id)
        {
            ...
            try
            {
                ...
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery() == 1 ? "OK" : "No se pudo activar";
